...
public class Graph_Academics_4 extends MainActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.graph_4);
...
//        yvalues.add(new Entry(5,10f));
                LineDataSet set1=new LineDataSet(yvalues,"Subject4");
                ...
                xAxis.setValueFormatter(new Graph_Academics_4.MyXAxis(values));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Graph_Academics_4.this, Graph_Academics_5.class);
