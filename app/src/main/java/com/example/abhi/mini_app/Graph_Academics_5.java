...
public class Graph_Academics_5 extends MainActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.graph_5);
        mChart = (LineChart)findViewById(R.id.lineChart5);
...
//        yvalues.add(new Entry(5,10f));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Graph_Academics_5.this, Home_screen.class);
