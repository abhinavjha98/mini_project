...
public class Graph_Academics_3 extends MainActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.graph_3);
...
//        yvalues.add(new Entry(5,10f));
                LineDataSet set1=new LineDataSet(yvalues,"Subject3");
                ...
                xAxis.setValueFormatter(new Graph_Academics_3.MyXAxis(values));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Graph_Academics_3.this, Graph_Academics_4.class);
